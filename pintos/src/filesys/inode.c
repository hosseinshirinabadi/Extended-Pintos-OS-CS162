  ...
  if (disk_inode != NULL)
    {
      ...
      if (sectors > 12 && sectors < NUM_DIRECT_POINTERS + NUM_POINTERS_PER_INDIRECT) {
        ...
        for (int i = 0; i < sectors - NUM_DIRECT_POINTERS; i++) {
      ...
      if (success) {
        ...
        for (int i = 0; i < sectors; i++) {
          ...
          write_to_cache(disk_inode->direct_pointers[i], )
        }
      }
